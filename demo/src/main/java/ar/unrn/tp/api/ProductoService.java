...
public interface ProductoService {
    ...
    void crearProducto(int codigo, String descripcion, double precio, Long categoria, Long marca);
    //validar que sea un producto existente
    void modificarProducto(Long idProducto, int codigo, String descripcion, double precio,  Long categoria, Long marca,Long version);
